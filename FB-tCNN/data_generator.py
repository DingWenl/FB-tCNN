...
def train_datagenerator(batchsize,train_data1,train_data2,train_data3,train_data4,win_train,y_lable, start_time, down_simple,tran_list, channel):
    while True:
...
def val_datagenerator(batchsize,train_data1,train_data2,train_data3,train_data4,win_train,y_lable, start_time, down_simple,val_list, channel):
    while True:
        x_train1, x_train2, x_train3, x_train4, y_train = list(range(batchsize)), list(range(batchsize)), list(range(batchsize)), list(range(batchsize)), list(range(batchsize))
        for i in range(batchsize):
