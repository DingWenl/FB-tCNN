...
def datagenerator(batchsize,train_data1,train_data2,train_data3,train_data4,win_train,y_lable, start_time, down_simple, channel):
...
def get_test_data(wn11,wn21,wn12,wn22,wn13,wn23,wn14,wn24,path='D:/dwl/data/SSVEP_5.6/sess01_subj02_EEG_SSVEP.mat', down_simple=4):
...
if __name__ == '__main__':
    ...
    for sub_selelct in range(1, 10):
        ...
        data1, data2, data3, data4, label, start_time = get_test_data(wn11,wn21,wn12,wn22,wn13,wn23,wn14,wn24,path,down_simple)
        av_acc_list = []
        for t_train in t_train_list:
            ...
            # model_path = 'D:/dwl/code_ssvep/ssvep_coda_ding_/model/model33-01.h5'
            model = load_model(model_path)
            print("load successed")
            print(t_train, sub_selelct)
            acc_list = []
            for j in range(5):
                x_train,y_train = datagenerator(batchsize,data1, data2, data3, data4,win_train,label, start_time, down_simple, channel)
                a, b = 0, 0
        ...
        # model.summary(line_length=150,positions=[0.3,0.6,0.7,1.])
